...
# select_element = driver.find_element(By.XPATH, '//*[@id="ui-id-2"]')
# select = Select(select_element)
# select.select_by_visible_text('Abril / 2023')
...
for index,row in pd_tabela.iterrows(): 
    ...
    driver.find_element(By.XPATH, f'//*[@id="descontos_panel"]/tbody/tr[1]/td[1]/a').click()
    time.sleep(2)
...
# driver.find_element(By.XPATH, '//*[@id="descontos_panel"]/tbody/tr[1]/td[1]/a').click()
# time.sleep(3)
# iframe = driver.find_element(By.CSS_SELECTOR, 'table.dataTable.no-footer')
